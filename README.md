...
> **ملاحظة أمنية:** لا تدرج بيانات اعتماد حقيقية في الـ README.
> بعد الإعداد الأولي، غيّر كلمة مرور حساب المدير فوراً من لوحة التحكم،
> أو أنشئ حساب مدير جديد ببيانات سرية واحذف الافتراضي.
