      ...
      >
        <div className="card p-8">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-500 mt-1">مرحباً بعودتك! سجل دخولك للمتابعة</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="relative">
              ...
              <button
                ...
                className="absolute left-3 top-[38px] text-gray-400 hover:text-gray-600 dark:hover:text-gray-300"
              >
