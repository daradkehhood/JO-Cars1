...
export function FeaturedCars() {
  ...
  return (
    <section ref={ref} className="py-16 sm:py-20 relative">
      ...
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[600px] h-[300px] bg-gold-500/[0.04] rounded-full blur-[100px] pointer-events-none" />
          ...
          <div>
            <div className="flex items-center gap-3 mb-4">
              <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-gold shadow-gold"
                ...
                <Star className="w-5 h-5 text-primary-900 fill-primary-900" />
              </div>
              <span className="text-sm font-bold uppercase tracking-wider text-gold-600 dark:text-gold-400"
