          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
            <div>
              <div className="flex items-center gap-2 mb-3">
                <div className={cn('w-9 h-9 rounded-2xl bg-warning-50 dark:bg-warning-500/10 flex items-center justify-center', isInView ? 'scroll-visible-scale' : 'scroll-hidden-scale')} style={{ transitionDelay: '0.1s' }}>
                  <Star className="w-4.5 h-4.5 text-warning-500 fill-warning-500" />
                </div>
              ...
              <p className={cn('section-subtitle max-w-xl', isInView ? 'scroll-visible' : 'scroll-hidden')} style={{ transitionDelay: '0.25s' }}>
                عروض قوية تم اختيارها بعناية لتظهر بشكل أوضح وتفتح باب الثقة من أول نظرة.
              </p>
            </div>
